...
## aliases for assay functions
##' @export
poplin_raw_list <- function(...) SummarizedExperiment::assays(...)

##' @export
poplin_raw_names <- function(...) SummarizedExperiment::assayNames(...)

##' @export
poplin_raw <- function(...) SummarizedExperiment::assay(...)
